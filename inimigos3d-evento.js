...
// ════════════════════════════════════════════════════════════════
        ...
        function tickFormacao(dt) {
            ...
            if (!formacaoAtiva) {
                if (enemies.length === 0) {
                    ...
                    if (!window._eventoInfinito && formacoesConcluidas > 0 && formacoesConcluidas % wavesDoNivel === 0) {
                        iniciarBoss();
                    } else {
                        iniciarFormacao();
                    }
        ...
        function destruirInimigo(enemy) {
            ...
            if (enemy.isBoss) {
                ...
                bossesDerrotados++;
                if (!window._eventoInfinito && bossesDerrotados >= BOSSES_PARA_VITORIA) { venceuJogo(); return; }
