...
// ════════════════════════════════════════════════════════════════
        ...
        const shootSound = new Audio('tiro5.mp3');
        shootSound.volume = 0.75;
        const enemyDeathSound = new Audio('kill-inimigos.mp3');
        ...
        function dispararTiroJogador() {
            if (VANGUARD_SOM_TIRO) { try { vanguardTocarSom(VANGUARD_SOM_TIRO); } catch (e) { tocarSom(shootSound); } }
            else tocarSom(shootSound);
        ...
        function cooldownTiroAtual() {
            return jogadorPowerup === 'RAPID' ? SHOOT_COOLDOWN_RAPID : SHOOT_COOLDOWN_NORMAL / CADENCIA_MULT;
        }
        ...
        function sofrerDano(qtd) {
            ...
            if (playerHp <= 0) {
                ...
                if (!reviveUsado) mostrarTelaRevive(); else encerrarPartida();
            }
        }
